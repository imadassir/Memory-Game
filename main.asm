...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;
		...
		CALL	WLCM
		CALL	MENU
		;BSF	INTCON,T0IE		;USED FOR TESTING
TASK	GOTO 	TASK
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
END5	BCF		INTCON,RBIF		;END OF INTERRUPT ROUTINES
		RETFIE
...
T2		MOVLW	B'01000'		;GOTO ADDRESS 13 TO CHANGE THE VALUE OF THE TIMER DISPLAYED
		...
		MOVF	TMRVAL,W
		BTFSC	STATUS,Z		;CHECK IF TIMER HIT 0
		GOTO	SCORE2			;AND END MODE 2 IF IT DID
		CALL	SLCDA			
...
DELAY1S	MOVLW   H'0' ;w =0		
        MOVWF   COUNT1 ; count1 = 0
		MOVLW	d'5' ; w = 52
        MOVWF	COUNT3 ; count2 = 0

OUTERL  INCFSZ	COUNT1,F ;count1++
      	GOTO    OUTERL
		INCFSZ	COUNT2,F
		GOTO	OUTERL
		DECFSZ	COUNT3,F
...
DD1		CALL	PRINT1		;DOUBLE DIGIT CASE FOR EXIT CASE OF MODE 3
		;BSF		TEMP,4
		MOVF	TEMP,W
		MOVWF	TMRVAL
		CALL	PRINTFR	

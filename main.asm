...
ACARDO	EQU		d'31'	;ADDRESS OF CARD OPENED
CARDO	EQU		d'32'	;CARD OPENED
...
FLIP	BTFSC	INDF,7		;CHECK IF CARD WAS OPENED BEFORE
		...
		MOVF	FSR,W		;SAVE THE REG NUM OF THE CARD THAT WAS OPENED
		MOVWF	CARDO
		MOVF 	LCDAL,W		;SAVE THE ADDRESS OF THE CARD THAT WAS OPENED
		MOVWF	ACARDO				
		BTFSC	NCARDO,1	;CHECK IF 2 CARDS WERE OPENED
		;CALL	HANDLE1
		CALL	LCDGH
		GOTO	END5
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
HANDLE1	SUBWF	CARDO,W		;COMPARE THE 2 CARDS OPENED
		...
		BCF		INDF,7		;FLAG PREV CARD AS OPENED	
		MOVF	NCARDO,W
		SUBLW	2			;SUBTRACT 2 FROM THE NUMBER OF CARDS OPENED (CLOSED THEM)
RET		RETURN

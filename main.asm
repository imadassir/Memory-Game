...
HANDLE1	MOVF	CARDN,W
		...
		MOVF	NCARDO,W
		SUBLW	D'10'		;SUBTRACT 2 FROM THE NUMBER OF CARDS OPENED (CLOSED THEM)
		MOVWF	NCARDO
...
RET		RETURN
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
ERRHAND	;BTFSS	ERRC,0	;CHECK IF THE ERROR COUNT IS ODD
		;GOTO	RETU
...
RETU	RETURN		
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
SCORE1	MOVLW	B'01100'	;SET PRINTING ADDRESS
		CALL	ET
		MOVLW	B'01010'
		CALL 	ET
		MOVLW	D'0'
